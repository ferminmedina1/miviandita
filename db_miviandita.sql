...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-09-2020 a las 02:18:23
...
--
ALTER TABLE `dirigido_table`
  MODIFY `id_dirigidoA` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `viandas`
--
ALTER TABLE `viandas`
  MODIFY `id_vianda` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
